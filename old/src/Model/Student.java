...
public class Student extends Person
{
	...
	int i_Age, String i_ID , String i_NumberPhone, String i_NameOfAccademy, 
	eStatusOfNewCustomer i_Status, String i_Password)          
	{
		
		super(i_FirstName, i_LastName, i_Mail, i_City, i_Address, i_Age, i_ID, i_NumberPhone, i_Password, i_Status);
